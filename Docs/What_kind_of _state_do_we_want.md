...
![Δύο διαγράμματα για την Ελλάδα: συσωρευτικά κρούσματα και συσσωρευτικοί θάνατοι με ένδειξη τιμών στις 29/11/2020.](image.png)<br>
...
![«Δύο διαγράμματα: ημερήσια κρούσματα και ημερήσιοι θάνατοι στην Ελλάδα, με επισημασμένες κορυφώσεις σε διαφορετικές ημερομηνίες.»](image-1.png)
...
![«Διάγραμμα διασωληνωμένων στην Ελλάδα με απότομη αύξηση και κορύφωση γύρω στις 29/11/2020.»](image-2.png)
